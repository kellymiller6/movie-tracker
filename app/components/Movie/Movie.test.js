...
describe('Movie', () => {
  ...
  it('should render a movie card', () => {
    let wrapper = shallow(<Movie movieData={movie} user='' addFavorite={addFavorite} deleteFavorite={deleteFavorite} fetchFavorites={fetchFavorites} favorites={favorites} />)
